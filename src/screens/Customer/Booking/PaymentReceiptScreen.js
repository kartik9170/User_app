    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable onPress={downloadReceipt} style={styles.downloadBtn}>
          <MaterialIcons name="download" size={18} color="#FF6B2C" />
...
const styles = StyleSheet.create({
  ...
  successIcon: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#FF6B2C', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  ...
  strong: { fontSize: fontScale(15), fontWeight: '800', color: '#FF6B2C' },
  ...
  downloadText: { color: '#FF6B2C', fontSize: fontScale(14), fontWeight: '700' },
  trackBtn: {
    minHeight: 50,
    borderRadius: 12,
